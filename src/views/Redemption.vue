		...
		<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
			<div class="container-fluid d-flex flex-column p-0">
				...
				<ul class="nav navbar-nav text-light" id="accordionSidebar">
					<li class="nav-item">
						<router-link to="/" class="nav-link"><i class="fas fa-table"></i><span>Merchant Report</span></router-link>
					</li>
					<li class="nav-item">
						<router-link to="/history" class="nav-link active"><i class="far fa-user-circle"></i><span>Redemption Report</span></router-link>
					</li>
				</ul>
								...
								<div class="nav-item dropdown no-arrow">
									...
									<div class="dropdown-menu shadow dropdown-menu-right animated--grow-in">
										<a v-if="items.length > 0" class="dropdown-item" href="#">
											...
											<download-excel class="btn btn-default" :data="items" :fields='{"voucher id":"voucher_id", "voucher code":"voucher_code", "voucher status": "voucher_status", "voucher date": "voucher_date", "redemption date time": "redemption_date_time", "order id": "order_id", "order date": "order_date", "order status":"order_status", "product id":"product_id", "billing email":"billing_email", "billing name":"billing_name", "billing phone":"billing phone", "item total":"item_total", "SKU":"SKU", "merchant":"merchant" }' worksheet="My Worksheet" name="Brawta Redemption Report.xls" style="padding: 0;color:#2e2f37;font-size: .85rem;">
												Download
											</download-excel>
										</a>
				...
				<div class="container-fluid">
					<div class="card shadow">
						<div class="card-header py-3">
							<div class="row">
								<div class="col">
									<p class="text-primary m-0 font-weight-bold">Redemption Info</p>
								</div>
...
export default {
	...
	data() {
		return {
			...
			columnNames: ["voucher id", "voucher code", "voucher status", "voucher date", "redemption date time", "order id", "order date", "order status", "product id", "billing email", "billing_name", "billing phone", "item total", "SKU", "merchant"],
	...
	methods: {
		...
		addNewItem() {
			...
			this.socket.emit("RedemptionSearch", data);
		}
	}
};
</script>
